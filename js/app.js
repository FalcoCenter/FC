...
class TechServiceApp {
        ...
        this.portfolioData = [
            {
                ...
                title: 'صيانة بوردة Dell',
                description: 'تنظيف مداخل USB و F_panel'
            },
            {
                id: 2,
            ...
            },
            {
                ...
                title: 'تثبيت نسخة تشغيل',
                description: 'تثبيت نسخة تشغيل بصعوبة بعد إصلاح قطاعات هارد تالفة'
            },
            {
                id: 7,
                category: 'design',
            ...
            },
            {
                ...
                description: 'تفكيك كامل لمكونات الجهاز - تطهير فتحات التهوية والمرشحات - فحص وتنظيف مشتت الحرارة - معايرة سرعات المراوح - استخدام هواء مضغوط لإزالة الأتربة - تأمين كافة الوصلات والكابلات'
            },
            {
                id: 11,
                category: 'design',
                image: 'https://i.ibb.co/3YFWfSqt/Quassim-Font-Foundation.png',
                title: 'تصميم لوغو',
                description: 'تصميم لوغو مؤسسة أبو القاسم الحسيني للخط العربي'
            },
        ];
    ...
    getChatbotResponse(message) {
        ...
        const responses = {
            ...
            'أعمال': 'يمكنك مشاهدة أعمالنا في قسم "أعمالنا" في الموقع.',
    ...
    validateBookingForm() {
        ...
        if (!phone || !this.validateEgyptPhone(phone)) {
            this.showError('الرجاء إدخال رقم هاتف مصري صحيح');
    ...
    validateEgyptPhone(number) {
        ...
        return mobileRegex.test(cleaned) || landlineRegex.test(cleaned) || serviceRegex.test(cleaned);
    }
